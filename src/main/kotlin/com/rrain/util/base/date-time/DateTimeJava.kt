...
fun String.toZonedDateTime() = (
  ZonedDateTime.parse(this, zonedDateTimeFormatter)
)
...
fun String.toJavaLocalDate(): LocalDate = (
...
fun main() {
  ...
  run {
    ...
    // ok: 1997-11-02
    println("1997-11-02".toJavaLocalDate())
    
    // Exception in thread "main" java.time.format.DateTimeParseException:
    // Text '1997-11-2' could not be parsed at index 8
    println("1997-11-2".toJavaLocalDate())
