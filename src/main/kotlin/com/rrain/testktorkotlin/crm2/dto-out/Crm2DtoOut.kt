package com.rrain.testktorkotlin.crm2.`dto-out`

import com.rrain.testktorkotlin.crm2.`dto-in`.Crm2DtoIn
import com.rrain.testktorkotlin.crm2.store.Crm2Store
import com.rrain.testktorkotlin.crm2.store.Crm2Store.Brands
import com.rrain.testktorkotlin.crm2.store.Crm2Store.CompanyToSales
import com.rrain.testktorkotlin.crm2.store.Crm2Store.CompanyToSegments
import com.rrain.testktorkotlin.crm2.store.Crm2Store.Curators
import com.rrain.testktorkotlin.crm2.store.Crm2Store.Legals
import com.rrain.testktorkotlin.crm2.store.Crm2Store.Sales
import com.rrain.testktorkotlin.crm2.store.Crm2Store.Segments
import com.rrain.testktorkotlin.crm2.store.Crm2Store.Settlements
import com.rrain.testktorkotlin.crm2.store.Crm2Store.Technologies
...
data object Crm2DtoOut {
  ...
  fun List<Crm2Store.Company>.toDto(getDtoIn: com.rrain.testktorkotlin.crm2.`dto-in`.Crm2DtoIn.Get? = null): List<CompanyShortDto> {
    return this
      .map {
