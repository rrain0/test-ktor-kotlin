...
import com.rrain.crm2.`dto-in`.Crm2DtoIn.EmptyGet
import com.rrain.crm2.`dto-out`.Crm2DtoOut.toDto
import com.rrain.crm2.store.Crm2Store
import com.rrain.crm2.store.Crm2Store.Companies
...
fun Application.configureCrm2CompanyRouting() {
  routing {
    ...
    post("/api/company/list") {
      ...
      val getData = call.receive<Crm2DtoIn.Get>()
